...
* The mean is 1.0766\times 10^{4} steps per day
* the median is 10765 steps per day

btw: it looks wired to see "1.076610^{4}" for mean, but it is generated by my RSudio. if I run it from the command line, I saw "10766".
